...
function(window,document,body) {
	...
	//*/
	var m_destroy = function destroy(p_callback) { lf.clear(function localforageClear(p_error) { m_invokeCallback(p_callback,typeof(p_callback)=="string",(p_error!=null) ? "error" : "destroy",p_error); }); };
